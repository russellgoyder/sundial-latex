...
\address{10 Althorpe Court, Ely, Cambridgeshire, CB6 3DH, UK}
\ead{Russell@Goyder.org}
\begin{abstract}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=14cm]{figs/figure1.eps} 
%\includegraphics{figs/figure1.eps} 
...
G & = & R_d R_i \, n_1 \wdg n_2 \, \tilde{R}_i \tilde{R}_d \\ \nn
  & = & \cos i \; n_1 \wdg n_2 - \sin i ( \cos d \; n_2 \wdg n_3 + \sin d \; n_3 \wdg n_1 )
\end{eqnarray}
%
...
\end{eqnarray}
%
$m_1$ points in the direction of steepest descent of the dial face, $m_2$ is horizontal (parallel to $n_1 \wdg n_2$), $m_3$ is normal to the face and  $m_1 \wdg m_2$ is just $G$. This can be seen in Figure~\ref{dialGeom} which shows the dial face as a dashed square outline.
%
...
\begin{figure}[ht!]
  ...
  \begin{minipage}[t]{.45\textwidth}
    \begin{center}  
	\includegraphics[width=7cm]{figs/figure3.eps}
  ...
  \begin{minipage}[t]{.45\textwidth}
    \begin{center}  
      \includegraphics[width=7cm]{figs/figure4.eps}
...
Lines on a sundial are typically constructed relative to the shadow at noon (the ``noon line''). Noon occurs when the sun passes through the meridian plane $M=n_1 \wdg n_2$. 
...
\end{equation}
%
In the above, all of the dependence on $\sigma$, $\psi$ and $\alpha$, the physical parameters of the Earth's orbit is contained within $\mu$ and we have have formulae which relate $\mu$ to the geometry we have chosen for the sundial ($i$, $d$ and $\iota$). Our expression for the shadow bearing (\ref{shadBearing}) then yields
%
...
\begin{figure}[ht!]
\centering
\includegraphics[width=14cm]{figs/figure6.eps}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=14cm]{figs/figure7.eps}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=14cm]{figs/figure8.eps} 
...
\begin{figure}[ht!]
\centering
\includegraphics[width=14cm]{figs/figure9.eps} 
...
\end{equation}
%
For the case considered by Rohr, we have $\iota = \pi/2 - \theta_L$ and we have
%
\begin{equation}
...
%
% ----------------------------------------------------------------- %
\subsubsection{Common types of sundial} \label{secCommonTypes}
%
...
%
\begin{equation}
L = \frac{\cos\mu}{D_h\tan\mathrm{dec}}\sqrt{1 + \tan^2\mu\cos^2\theta}
\end{equation}
%
...
%
Toward the end of a visit to see my family in Canada last year, I was sitting with my 93 year-old grandfather in his garden before leaving for the airport at 5pm. I didn't want to be late but had left my watch inside -- I was about to get it to check the time when my grandfather told me not to worry; he had observed that the shadow cast by a fence post was parallel to the sides of the paving slabs of his patio at 5pm the previous day. As the shadow was falling about $15^\circ$ from that line, he said that at a rate of about $1^\circ$ every 4 minutes, I had about an hour left.
...
\frac{d^2U}{ds^2} = \left(-\frac{kx}{\mu r^2} + \frac{\dot{x}^2}{2} \right) U = -\om^2 U
\end{equation}
%
where
%
